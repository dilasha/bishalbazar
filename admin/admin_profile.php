		...
		<div class="content row">
			...
			<div class="col-md-offset-1 col-md-5">
				...
				<table class="table table-bordered">
					...
					<tr>
						<th>Deactivate</th>
						<td><a class="link" href="admin_deactivate.php?id=<?php echo $id; ?>">Deactivate</a></td>
					</tr>
					<tr>
						<th>Delete</th>
						<td><a onclick='return ConfirmDelete()' class="link" href="admin_delete.php?id=<?php echo $id; ?>">Delete Profile</a></td>
					</tr>
				</table>
